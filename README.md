...
This project is part of the [DFIR-OGRE](https://github.com/ANSSI-FR/dfir-ogre) suite and provides a low level Rust runtime to run DFIR-OGRE plugins.

Please refers to the ogre documentation for more details.
